...
database = {}
database["ashish"] = img_to_encoding("image/ashish.jpeg", FRmodel)
database["aman"] = img_to_encoding("image/aman.jpeg", FRmodel)
database["mayur"] = img_to_encoding("image/mayur.jpeg", FRmodel)
database["ketan"] = img_to_encoding("image/ketan.jpeg", FRmodel)
...
who_is_it("image/resized/Resized_deblured/1/1_4_resize.jpg", database, FRmodel)
